...
export class StorePage extends Component {
  ...
  handleSortByMaxPrice = () => {
      this.props.startSortByMaxPrice();
  }

  handleSortByMinPrice = () => {
    this.props.startSortByMinPrice();
  }

  handleSetMaxPrice = (e) => {
    this.props.startSetMaxPrice(e.target.value);
  }

  handleSetMinPrice = (e) => {
    this.props.startSetMinPrice(e.target.value);
  }

  handleSetCategory = (e) => {
        this.props.startSetCategory(e.target.value);
  }

  handleSetBrand = (e) => {
      this.props.startSetBrand(e.target.value);
  }
      ...
      <div className='mt'>
        ...
        <div className='store-page'>
            <div className='filter-button'>
                <Button onClick={this.toggleVisibility} floated='right' color='teal' icon='filter' /> 
            </div>
            <div>
